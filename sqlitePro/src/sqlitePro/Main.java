...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String sql2 = "insert into g_artists (name, a_type, a_year, debut, regdate)"+" values ('방탄소년단','남성','2010년대, 2020년대','2013년',datetime('now', 'localtime'));";
			...
			int cnt4 = stat4.executeUpdate(sql3);
			if(cnt4>0)
				System.out.println("데이터가 수정되었습니다!");
			else
				System.out.println("[Error] 데이터 수정 오류!");
